        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    ...
                    <div class="card-body">
                        <table id="customer_table9" class="table">
                            <thead>
                                <tr>
...
<!-- Model customer -->
    <div class="modal fade edit-layout-modal pr-0" id="customerAdd" role="dialog" aria-labelledby="customerAddLabel" style="display: none;" aria-hidden="true">
    ...
    <div class="modal fade edit-layout-modal pr-0" id="customerEdit" role="dialog" aria-labelledby="customerEditLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog w-300" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="customer/update" method="post">
                        ...
                        <div class="form-group">
                            <label class="d-block">customer Name</label>
                            <input type="text" name="name" id="name" class="form-control" placeholder="Enter customer Name" value="" >
                        </div>
                        <div class="form-group">
                            <label class="d-block">Phone</label>
    ...
    <script>
            $(document).on('click', '#editcustomer',function() {
                ...
                var token = $('#token').val();
                var ur = "customer/edit/"+customerId;
        $.ajax({
            url : ur ,
            type: 'get',
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/customer.blade.php ENDPATH**/ ?>
    ...
    <body class="home-gradient-bg">
		<div class="container ">
			<div class="d-flex justify-content-between my-5">
				<div>
					<a href="https://themicly.com/products/radmin/">
		            	<img height="30" src="<?php echo e(asset('img/logo.png')); ?>">
		            </a>
				</div>
				<div>
					<a class="btn btn-success btn-rounded mr-3" href="<?php echo e(url('login')); ?>/">Demo</a>
	    	...
	    	<div class="banner-text m-4 d-relative">
	    		<img height="50" class="d-absolute left-0"  src="<?php echo e(asset('/img/p1.png')); ?>">
	    		<img height="300" class="d-absolute"  src="<?php echo e(asset('/img/s1-2.png')); ?>">
	    		<img height="50" class="d-absolute right-0"  src="<?php echo e(asset('/img/s2-2.png')); ?>">
	    		Let your engineers <br> build the backend!
	    	</div>

	    	<div class="radmin-bannner text-center">
	    		<img  src="<?php echo e(asset('/img/radmin.jpg')); ?>">
	    	</div>
...
<?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/home.blade.php ENDPATH**/ ?>
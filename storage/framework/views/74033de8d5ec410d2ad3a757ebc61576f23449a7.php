			...
			<div class="card">
				<div class="card-header row">
					<div class="col col-sm-2">
						<a href="<?php echo e(url('products/create')); ?>" class="btn btn-sm btn-primary btn-rounded">Add Product</a>
					</div>
...
<?php echo $__env->make('inventory.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/inventory/product/list.blade.php ENDPATH**/ ?>
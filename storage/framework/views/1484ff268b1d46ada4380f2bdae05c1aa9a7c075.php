                    ...
                    <table id="advanced_table" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item['purchased_date']); ?></td>
                                <td><?php echo e($item['supported_date']); ?></td>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="purchased_date" class="form-control" placeholder="Enter purchased date" value="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('accounting.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/accounting/assets.blade.php ENDPATH**/ ?>
                    ...
                    <div class="d-block d-md-inline-block">
                        <div class="btn-group float-md-left mr-1 mb-1">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><?php echo e(__('DESC')); ?></a>
                                <a class="dropdown-item" href="#"><?php echo e(__('ASC')); ?></a>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-4 list-item list-item-grid">
                    <div class="card d-flex flex-row mb-3">
                        <a class="d-flex card-img" href="#categoryView" data-toggle="modal" data-target="#categoryView">
                            <img src="<?php echo e(asset($category['image'])); ?>" alt="<?php echo e($category['name']); ?>" class="list-thumbnail responsive border-0">
                        </a>
                        <div class="d-flex flex-grow-1 min-width-zero card-content">
                            <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center mb-0">
                                ...
                                <p class="mb-1 w-15 w-xs-100">
                                    Total <?php echo e($category['items']); ?> items
                                </p>
                            </div>
    ...
    <div class="modal-dialog w-300" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="categoryAddLabel"><?php echo e(__('Add Category')); ?></h5>
...
<div class="modal fade edit-layout-modal pr-0 " id="categoryView" tabindex="-1" role="dialog" aria-labelledby="categoryViewLabel" aria-hidden="true">
    <div class="modal-dialog w-300" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="categoryViewLabel"><?php echo e(__('Edit Category')); ?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
...
<?php echo $__env->make('inventory.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/inventory/category/index.blade.php ENDPATH**/ ?>
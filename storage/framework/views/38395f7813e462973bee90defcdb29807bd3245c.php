    ...
    <div class="container ">
        ...
        <div class="card">
            <div class="card-header text-center">
              <h4><i class="ik ik-gift bg-blue" style="padding: 10px; border-radius: 5px;color: white"></i> Warranty</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/warranty.blade.php ENDPATH**/ ?>
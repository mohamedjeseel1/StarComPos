...
<?php $__env->startSection('title', 'Form Advance'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Advance')); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3><?php echo e(__('Switches')); ?></h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-xl-4 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Single Switche')); ?></h4>
                                <input type="checkbox" class="js-single" checked />
                            </div>
                            <div class="col-sm-12 col-xl-4 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Multiple Switches')); ?></h4>
                                <input type="checkbox" class="js-switch" checked />
                                <input type="checkbox" class="js-switch" checked />
                                <input type="checkbox" class="js-switch" checked />
                            </div>
                            <div class="col-sm-12 col-xl-4 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Enable Disable Switches')); ?></h4>
                                <input type="checkbox" class="js-dynamic-state" checked />
                                <button class="btn btn-primary js-dynamic-enable"><?php echo e(__('Enable')); ?></button>
                                <button class="btn btn-inverse js-dynamic-disable"><?php echo e(__('Disable')); ?></button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-8">
                                <h4 class="sub-title"><?php echo e(__('Color Switches')); ?></h4>
                            ...
                            <div class="col-sm-4">
                                <h4 class="sub-title"><?php echo e(__('Switch Sizes')); ?></h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3><?php echo e(__('Radio')); ?></h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-xl-4 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Radio Fill Button')); ?></h4>
                                <div class="form-radio">
                                    <form>
                                        <div class="radio radio-inline">
                                            <label>
                                                <input type="radio" name="radio" checked="checked">
                                                <i class="helper"></i><?php echo e(__('Radio 1')); ?>
                                        ...
                                        <div class="radio radio-inline">
                                            <label>
                                                ...
                                                <i class="helper"></i><?php echo e(__('Radio 2')); ?>
                                        ...
                                        <div class="radio radio-inline radio-disable">
                                            <label>
                                                ...
                                                <i class="helper"></i><?php echo e(__('Radio Disable')); ?>
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Radio outline Button')); ?></h4>
                                <div class="form-radio">
                                    <form>
                            ...
                            <div class="col-sm-12 col-md-6 col-xl-4 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Radio Button')); ?></h4>
                                <div class="form-radio">
                                    <form>
                                        <div class="radio radiofill radio-inline">
                                            <label>
                                                <input type="radio" name="radio" checked="checked">
                                                <i class="helper"></i><?php echo e(__('Radio-fill 1')); ?>
                                        ...
                                        <div class="radio radiofill radio-inline">
                                            <label>
                                                <input type="radio" name="radio">
                                                <i class="helper"></i><?php echo e(__('Radio-fill 2')); ?>
                                        ...
                                        <div class="radio radiofill radio-inline radio-disable">
                                            <label>
                                                <input type="radio" disabled="" name="radio">
                                                <i class="helper"></i><?php echo e(__('Radio-fill Disable')); ?>
                        ...
                        <h4 class="sub-title"><?php echo e(__('Color Radio Button')); ?></h4>
                        <div class="form-radio mb-30">
                            <form>
                                <div class="radio radiofill radio-default radio-inline">
                                    <label>
                                        <input type="radio" name="radio" checked="checked">
                                        <i class="helper"></i><?php echo e(__('Default Color')); ?>
                                ...
                                <div class="radio radiofill radio-primary radio-inline">
                                    <label>
                                        <input type="radio" name="radio" checked="checked">
                                        <i class="helper"></i><?php echo e(__('Primary Color')); ?>
                                ...
                                <div class="radio radiofill radio-success radio-inline">
                                    <label>
                                        <input type="radio" name="radio" checked="checked">
                                        <i class="helper"></i><?php echo e(__('Success Color')); ?>
                                ...
                                <div class="radio radiofill radio-info radio-inline">
                                    <label>
                                        <input type="radio" name="radio" checked="checked">
                                        <i class="helper"></i><?php echo e(__('Info Color')); ?>
                                ...
                                <div class="radio radiofill radio-warning radio-inline">
                                    <label>
                                        <input type="radio" name="radio" checked="checked">
                                        <i class="helper"></i><?php echo e(__('Warning Color')); ?>
                                ...
                                <div class="radio radiofill radio-danger radio-inline">
                                    <label>
                                        <input type="radio" name="radio" checked="checked">
                                        <i class="helper"></i><?php echo e(__('Danger Color')); ?>
                                ...
                                <div class="radio radiofill radio-inverse radio-inline">
                                    <label>
                                        <input type="radio" name="radio" checked="checked">
                                        <i class="helper"></i><?php echo e(__('Inverse Color')); ?>

                                    </label>
                                </div>
                            </form>
                        </div>
                        <h4 class="sub-title"><?php echo e(__('Color Radio material Button')); ?></h4>
                        <div class="form-radio mb-30">
                            <form>
                ...
                <div class="card">
                    <div class="card-header">
                        <h3><?php echo e(__('Checkbox')); ?></h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 col-xl-6 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Border Checkbox')); ?></h4>
                                <div class="border-checkbox-section">
                                    <div class="border-checkbox-group border-checkbox-group-default">
                                        ...
                                        <label class="border-checkbox-label" for="checkbox0"><?php echo e(__('Do you like it?')); ?></label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-primary">
                                        <input class="border-checkbox" type="checkbox" id="checkbox1">
                                        <label class="border-checkbox-label" for="checkbox1"><?php echo e(__('Primary')); ?></label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-success">
                                        <input class="border-checkbox" type="checkbox" id="checkbox2">
                                        <label class="border-checkbox-label" for="checkbox2"><?php echo e(__('Success')); ?></label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-info">
                                        <input class="border-checkbox" type="checkbox" id="checkbox3">
                                        <label class="border-checkbox-label" for="checkbox3"><?php echo e(__('Info')); ?></label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-warning">
                                        <input class="border-checkbox" type="checkbox" id="checkbox4">
                                        <label class="border-checkbox-label" for="checkbox4"><?php echo e(__('Warning')); ?></label>
                                    </div>
                                    <div class="border-checkbox-group border-checkbox-group-danger">
                                        <input class="border-checkbox" type="checkbox" id="checkbox5">
                                        <label class="border-checkbox-label" for="checkbox5"><?php echo e(__('Danger')); ?></label>
                                    </div>
                                    <div class="border-checkbox-group">
                                        <input class="border-checkbox" type="checkbox" id="checkbox6" disabled>
                                        <label class="border-checkbox-label" for="checkbox6"><?php echo e(__('Disabled')); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 col-xl-6 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Fade-in Checkbox')); ?></h4>
                                ...
                                <div class="checkbox-fade fade-in-primary">
                                    <label>
                                        ...
                                        <span><?php echo e(__('Primary')); ?></span>
                                    </label>
                                </div>
                                <div class="checkbox-fade fade-in-warning">
                                    <label>
                                        ...
                                        <span> <?php echo e(__('Warning')); ?></span>
                                    </label>
                                </div>
                                ...
                                <div class="checkbox-fade fade-in-danger">
                                    <label>
                                        ...
                                        <span> <?php echo e(__('Danger')); ?></span>
                                    </label>
                                </div>
                                <div class="checkbox-fade fade-in-disable">
                                    <label>
                                        ...
                                        <span><?php echo e(__('Disabled')); ?></span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-xl-6 mb-30">
                                <h4 class="sub-title"><?php echo e(__('Color Checkbox')); ?></h4>
                            ...
                            <div class="col-sm-12 col-xl-6 mb-30">
                                <h4 class="sub-title"><?php echo e(__('zoom Checkbox')); ?></h4>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header"><h3><?php echo e(__('Input Tag')); ?></h3></div>
                    <div class="card-body">
                        <form action="">
                            <div class="form-group">
                                <label for="input"><?php echo e(__('Type to add a new tag')); ?></label>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header"><h3><?php echo e(__('Form Repeater')); ?></h3></div>
                    <div class="card-body">
                        <p><?php echo e(__('Click the add button to repeat the form')); ?></p>
                        <form class="form-inline repeater">
                            <div data-repeater-list="group-a">
                                <div data-repeater-item class="d-flex mb-2">
                                    <label class="sr-only" for="inlineFormInputGroup1"><?php echo e(__('Users')); ?></label>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h3><?php echo e(__('Select 2')); ?></h3></div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form class="sample-form">
                                    <div class="form-group">
                                        <label for=""><?php echo e(__('Single select box using select 2')); ?> </label>
                                        <select class="form-control select2">
                                            <option value="cheese"><?php echo e(__('Cheese')); ?></option>
                                            <option value="tomatoes"><?php echo e(__('Tomatoes')); ?></option>
                                            <option value="mozarella"><?php echo e(__('Mozzarella')); ?></option>
                                            <option value="mushrooms"><?php echo e(__('Mushrooms')); ?></option>
                                            <option value="pepperoni"><?php echo e(__('Pepperoni')); ?></option>
                                            <option value="onions"><?php echo e(__('Onions')); ?></option>
                                        </select>
                                    </div>
                                </form>
                            </div>
                            <div class="col-md-6">
                                <form class="sample-form">
                                    <div class="form-group">
                                        <label for=""><?php echo e(__('Multiple select box using select 2')); ?> </label>
                                        <select class="form-control select2" multiple="multiple">
                                            <option value="cheese"><?php echo e(__('Cheese')); ?></option>
                                            <option value="tomatoes"><?php echo e(__('Tomatoes')); ?></option>
                                            <option value="mozarella"><?php echo e(__('Mozzarella')); ?></option>
                                            <option value="mushrooms"><?php echo e(__('Mushrooms')); ?></option>
                                            <option value="pepperoni" selected><?php echo e(__('Pepperoni')); ?></option>
                                            <option value="onions"><?php echo e(__('Onions')); ?></option>
                                        </select>
                                    </div>
                                </form>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h3><?php echo e(__('Summernote Editor')); ?></h3></div>
                    <div class="card-body">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/pages/form-advance.blade.php ENDPATH**/ ?>
                        ...
                        <table id="advanced_table" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>NewYork</td>
                                    <td>
                                        <a href="#supplierEdit" data-toggle="modal" data-target="#supplierEdit"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label class="d-block">Supplier Name</label>
                            <input type="text" name="name" class="form-control" placeholder="Enter Supplier Name" value="Computer Source">
                        </div>
                        <div class="form-group">
                            <label class="d-block">Code</label>
                            <input type="text" name="code" class="form-control" placeholder="Enter Code" value="SUP11">
                        </div>
                        <div class="form-group">
                            <label class="d-block">Phone</label>
                        ...
                        <div class="form-group">
                            <label class="d-block">Email</label>
                            <input type="text" name="email" class="form-control" placeholder="Enter Email" value="info@cp.com">
                        </div>
                        <div class="form-group">
                            <label>Country</label>
                            <select class="form-control select2" name="country">
...
<?php echo $__env->make('inventory.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/inventory/people/suppliers.blade.php ENDPATH**/ ?>
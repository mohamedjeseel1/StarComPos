                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center"> 
                            ...
                            <h4 class="card-title mt-10"><?php echo e(__('John Doe')); ?></h4>
                            <p class="card-subtitle"><?php echo e(__('Front End Developer')); ?></p>
                    ...
                    <hr class="mb-0"> 
                    <div class="card-body"> 
                        <small class="text-muted d-block"><?php echo e(__('Email address')); ?> </small>
                        <h6>johndoe@admin.com</h6> 
                        <small class="text-muted d-block pt-10"><?php echo e(__('Phone')); ?></small>
                        <h6>(123) 456 7890</h6> 
                        ...
                        <small class="text-muted d-block pt-30"><?php echo e(__('Social Profile')); ?></small>
                        <br/>
            ...
            <div class="col-lg-8 col-md-7">
                <div class="card">
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="true"><?php echo e(__('Timeline')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#last-month" role="tab" aria-controls="pills-profile" aria-selected="false"><?php echo e(__('Profile')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-setting" aria-selected="false"><?php echo e(__('Setting')); ?></a>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div> <a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                <div class="mt-20 row">
                                                    ...
                                                    <div class="col-md-9 col-xs-12">
                                                        <p> <?php echo e(__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.')); ?></p> <a href="javascript:void(0)" class="btn btn-success"> Design weblayout</a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="sl-item">
                                        ...
                                        <div class="sl-right">
                                            <div>
                                                ...
                                                <p class="mt-10"><?php echo e(__(' Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper')); ?> </p>
                                            </div>
                                            <div class="like-comm mt-20"> 
                                                <a href="javascript:void(0)" class="link mr-10">2 comment</a> 
                                                <a href="javascript:void(0)" class="link mr-10"><i class="fa fa-heart text-danger"></i> 5 Love</a> 
                                        ...
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span class="sl-date">5 minutes ago</span>
                                                <blockquote class="mt-10">
                                                    <?php echo e(__('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt')); ?>
                        ...
                        <div class="tab-pane fade" id="last-month" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3 col-6"> <strong><?php echo e(__('Full Name')); ?></strong>
                                        <br>
                                        <p class="text-muted">Johnathan Deo</p>
                                    </div>
                                    <div class="col-md-3 col-6"> <strong><?php echo e(__('Mobile')); ?></strong>
                                        <br>
                                        <p class="text-muted">(123) 456 7890</p>
                                    </div>
                                    <div class="col-md-3 col-6"> <strong><?php echo e(__('Email')); ?></strong>
                                        <br>
                                        <p class="text-muted">johnathan@admin.com</p>
                                    </div>
                                    <div class="col-md-3 col-6"> <strong><?php echo e(__('Location')); ?></strong>
                                        <br>
                                        <p class="text-muted">London</p>
                                    </div>
                                </div>
                                <hr>
                                <p class="mt-30"><?php echo e(__('Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt.Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.')); ?></p>
                                <p><?php echo e(__('Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries')); ?> </p>
                                <p><?php echo e(__('It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.')); ?></p>
                                <h4 class="mt-30"><?php echo e(__('Skill Set')); ?></h4>
                                <hr>
                                <h6 class="mt-30"><?php echo e(__('Wordpress')); ?> <span class="pull-right">80%</span></h6>
                                ...
                                <h6 class="mt-30"><?php echo e(__('HTML 5')); ?> <span class="pull-right">90%</span></h6>
                                <div class="progress  progress-sm">
                                ...
                                <h6 class="mt-30"><?php echo e(__('jQuery')); ?> <span class="pull-right">50%</span></h6>
                                <div class="progress  progress-sm">
                                ...
                                <h6 class="mt-30"><?php echo e(__('Photoshop')); ?> <span class="pull-right">70%</span></h6>
                                <div class="progress  progress-sm">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        <label for="example-name"><?php echo e(__('Full Name')); ?></label>
                                        <input type="text" placeholder="Johnathan Doe" class="form-control" name="example-name" id="example-name">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email"><?php echo e(__('Email')); ?></label>
                                    ...
                                    <div class="form-group">
                                        <label for="example-phone"><?php echo e(__('Phone No')); ?></label>
                                        <input type="text" placeholder="123 456 7890" id="example-phone" name="example-phone" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="example-message"><?php echo e(__('Message')); ?></label>
                                        <textarea name="example-message" name="example-message" rows="5" class="form-control"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-country"><?php echo e(__('Select Country')); ?></label>
                                        <select name="example-message" id="example-message" class="form-control">
                                            <option><?php echo e(__('London')); ?></option>
                                            <option><?php echo e(__('India')); ?></option>
                                            <option><?php echo e(__('Usa')); ?></option>
                                            <option><?php echo e(__('Canada')); ?></option>
                                            <option><?php echo e(__('Thailand')); ?></option>
                                        </select>
                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/pages/profile.blade.php ENDPATH**/ ?>
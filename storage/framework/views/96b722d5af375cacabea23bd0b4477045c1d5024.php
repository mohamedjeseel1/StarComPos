...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startPush('head'); ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('plugins/jvectormap/jquery-jvectormap.css')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('plugins/c3/c3.min.css')); ?>">
    ...
    <?php $__env->startPush('script'); ?> 
        ...
        <script src="<?php echo e(asset('plugins/jvectormap/jquery-jvectormap.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('plugins/d3/dist/d3.min.js')); ?>"></script>
        <script src="<?php echo e(asset('plugins/c3/c3.min.js')); ?>"></script>
        <script src="<?php echo e(asset('js/tables.js')); ?>"></script>
        <script src="<?php echo e(asset('js/widgets.js')); ?>"></script>
        <script src="<?php echo e(asset('js/charts.js')); ?>"></script>
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/pages/view.blade.php ENDPATH**/ ?>
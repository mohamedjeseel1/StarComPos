            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3>
                            <a href="#categoryAdd" data-toggle="modal" data-target="#categoryAdd" class="btn btn-sm btn-primary">Add category </a>
                        </h3>
                    </div>
                    <div class="card-body">
                        <table id="category_table3" class="table">
                            <thead>
                                <tr>
...
<!-- Model category -->
    <div class="modal fade edit-layout-modal pr-0" id="categoryAdd" role="dialog" aria-labelledby="categoryAddLabel" style="display: none;" aria-hidden="true">
    ...
    <div class="modal fade edit-layout-modal pr-0" id="categoryEdit" role="dialog" aria-labelledby="categoryEditLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog w-300" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="category/update" method="post">
                        ...
                        <div class="form-group">
                            <label class="d-block">Category Name</label>
                            <input type="text" name="name" id="name" class="form-control" placeholder="Enter category Name" value="" >
                        </div>
                        <div class="form-group">
                            <label class="d-block">Details</label>
    ...
    <script>
            $(document).on('click', '#editcategory',function() {
                ...
                var token = $('#token').val();
                var ur = "category/edit/"+categoryId;
        $.ajax({
            url : ur ,
            type: 'get',
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mohommadsu\Downloads\Main File\resources\views/category.blade.php ENDPATH**/ ?>